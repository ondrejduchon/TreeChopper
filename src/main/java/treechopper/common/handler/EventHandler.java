...
public class EventHandler {
    ...
    private boolean CheckWoodenBlock(World world, BlockPos blockPos) {
    ...
    private boolean CheckItemInHand(EntityPlayer entityPlayer) {
    ...
    private static Map<UUID, PlayerInteract> m_PlayerData = new HashMap<>();
